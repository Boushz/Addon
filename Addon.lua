...
already        = 'It seems you already have this addon, don\'t you try to mock me son!' 
		...
		-- beastmaster START -- 
function beastmasterFirst(cid, message, keywords, parameters, node) 
    ...
    addon = getPlayerStorageValue(cid,beastmaster) 
    if addon == -1 then 
        if getPlayerItemCount(cid,25378) >= 500 then 
        if doPlayerRemoveItem(cid,25378,500) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 636, 1) 
            doPlayerAddOutfit(cid, 637, 1) 
            setPlayerStorageValue(cid,beastmaster,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
function beastmasterSecond(cid, message, keywords, parameters, node) 
    ...
    if isPremium(cid) then 
    addon = getPlayerStorageValue(cid,beastmaster+1) 
    if addon == -1 then 
        if getPlayerItemCount(cid,25378) >= 1000 then 
        if doPlayerRemoveItem(cid,25378,1000) then 
            selfSay(newaddon, cid) 
              
            doSendMagicEffect(getCreaturePosition(cid), 13) 
            doPlayerAddOutfit(cid, 636, 2) 
            doPlayerAddOutfit(cid, 637, 2) 
            setPlayerStorageValue(cid,beastmaster+1,1) 
        end 
        else 
            selfSay(noitems, cid) 
        end 
...
-- beastmaster END --
		...
		-- entrepreneur START -- 
function entrepreneurFirst(cid, message, keywords, parameters, node) 
...
function entrepreneurSecond(cid, message, keywords, parameters, node) 
...
function riftSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,25378) >= 200 then 
        if doPlayerRemoveItem(cid,25378,200) then 
            selfSay(newaddon, cid) 
...
function YalaharianFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,21400) >= 5 then 
        if doPlayerRemoveItem(cid,21400,10) then 
            selfSay(newaddon, cid) 
...
function YalaharianSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,25378) >= 100 then 
        if doPlayerRemoveItem(cid,25378,100) then 
            selfSay(newaddon, cid) 
...
function PumpkinFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,21400) >= 15 then 
...
function PumpkinSecond(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,25378) >= 250 then 
        if doPlayerRemoveItem(cid,25378,250) then 
            selfSay(newaddon, cid) 
...
keywordHandler:addKeyword({'addons'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I can offer you first & second addons of the following outfits: Citizen, Hunter, Mage, Knight, Nobleman, Summoner, Warrior, Barbarian, Druid, Wizard, Oriental, Pirate, Assassin, Beggar, Shaman, Norseman, Elementalist, Nightmare, Jester, Brotherhood, Entrepreneur and Beastmaster."}) 
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and voíla - you got yourself an addon!"}) 
 ...
 node38 = keywordHandler:addKeyword({'second brotherhood addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second brotherhood addon you need to give me 1500 demonic essences (you will receive Necromancer Shield). Do you have them with you?'}) 
	...
	node41 = keywordHandler:addKeyword({'first pumpkin addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first pumpkin addon you need to give me 15 Silver Raid Tokens. Do you have them with you?'}) 
	...
	node42 = keywordHandler:addKeyword({'second pumpkin addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second pumpkin addon you need to give me 250 Copper Tokens. Do you have them with you?'}) 
	...
	node43 = keywordHandler:addKeyword({'first yalaharian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Yalaharian addon you need to give me 5 Silver Raid Tokens. Do you have them with you?'}) 
	...
	node44 = keywordHandler:addKeyword({'second yalaharian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Yalaharian addon you need to give me 100 Copper Tokens. Do you have them with you?'}) 
	...
	node46 = keywordHandler:addKeyword({'second glooth addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Glooth addon you need to give me 200 Copper Tokens. Do you have them with you?'}) 
	...
	node47 = keywordHandler:addKeyword({'first rift warrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Rift Warrior addon you need to give me 10 Silver Raid Tokens. Do you have them with you?'}) 
	...
	node48 = keywordHandler:addKeyword({'second rift warrior addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Rift Warrior addon you need to give me 200 Copper Token. Do you have them with you?'}) 
...
-- elementalist end
	...
	node51 = keywordHandler:addKeyword({'first entrepreneur addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Entrepreneur addon you need to give me 500 Copper Tokens. Do you have them with you?'}) 
    node51:addChildKeyword({'yes'}, entrepreneurFirst, {}) 
	...
	node52 = keywordHandler:addKeyword({'second entrepreneur addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Entrepreneur addon you need to give me 1000 Copper Tokens. Do you have them with you?'}) 
    node52:addChildKeyword({'yes'}, entrepreneurSecond, {}) 
...
--beastmaster	
	node53 = keywordHandler:addKeyword({'first beastmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first Beastmaster addon you need to give me 500 Copper Tokens. Do you have them with you?'}) 
    node53:addChildKeyword({'yes'}, entrepreneurFirst, {}) 
	...
	node54 = keywordHandler:addKeyword({'second beastmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second Beastmaster addon you need to give me 1000 Copper Tokens. Do you have them with you?'}) 
    node54:addChildKeyword({'yes'}, entrepreneurSecond, {}) 
